...
public class OrderServiceTest {
    ...
    public void 상품주문 () throws Exception {
        ...
        assertEquals("상품 준문시 상태는 ORDER", OrderStatus.ORDER, getOrder.getStatus());
        ...
        assertEquals("주문 수량만큼 재조가 줄어야 한다.", 8, book.getStockQuantity());
